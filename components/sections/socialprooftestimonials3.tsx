...
export const TestimonialCard = ({
  ...
  >
    ...
    <div className="flex w-full select-none items-center justify-start gap-5">
      <Image
        src={img || ""} // Provide a default value for the img prop
        alt=""
...
const testimonials = [
  ...
  },
  {
    ...
    description: (
      <p>
        Implementing #AIStream&rsquo;s customer prediction model has drastically
  ...
  },
  {
    ...
    description: (
      <p>
        As a startup, we need to move fast and stay ahead. #CodeAI&rsquo;s automated
  ...
  },
  {
    ...
    description: (
      <p>
        #VoiceGen&rsquo;s AI-driven voice synthesis has made creating global products
        a breeze.
  ...
  },
  {
    ...
    description: (
      <p>
        Leveraging #DataCrunch&rsquo;s AI for our financial models has given us an
  ...
  },
  {
    ...
    description: (
      <p>
        #LogiTech&rsquo;s supply chain optimization tools have drastically reduced our
        operational costs.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        By integrating #GreenTech&rsquo;s sustainable energy solutions, we&rsquo;ve seen a
  ...
  },
  {
    ...
    description: (
      <p>
        #TrendSetter&rsquo;s market analysis AI has transformed how we approach
        fashion trends.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        #LearnSmart&rsquo;s AI-driven personalized learning plans have doubled student
        performance metrics.
        <Highlight>Education tailored to every learner&rsquo;s needs.</Highlight>{" "}
  ...
  },
  {
    ...
    description: (
      <p>
        With #CyberShield&rsquo;s AI-powered security systems, our data protection
  ...
  },
  {
    ...
    description: (
      <p>
        #DesignPro&rsquo;s AI has streamlined our creative process, enhancing
  ...
  },
  {
    ...
    description: (
      <p>
        #VentureAI&rsquo;s insights into startup ecosystems have been invaluable for
